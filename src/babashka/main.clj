...
(def namespaces
  (cond->
    ...
    features/rebel-readline? (assoc 'rebel-readline.main @(resolve 'babashka.impl.rebel-readline/rebel-readline-main-namespace))
